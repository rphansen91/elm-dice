...
var _user$project$Main$dieBR = {ctor: '_Tuple2', _0: 0.8, _1: 0.8};
var _user$project$Main$dieBL = {ctor: '_Tuple2', _0: 0.2, _1: 0.8};
var _user$project$Main$dieCR = {ctor: '_Tuple2', _0: 0.8, _1: 0.5};
var _user$project$Main$dieCM = {ctor: '_Tuple2', _0: 0.5, _1: 0.5};
var _user$project$Main$dieCL = {ctor: '_Tuple2', _0: 0.2, _1: 0.5};
var _user$project$Main$dieTR = {ctor: '_Tuple2', _0: 0.8, _1: 0.2};
var _user$project$Main$dieTL = {ctor: '_Tuple2', _0: 0.2, _1: 0.2};
...
var _user$project$Main$scalar = F2(
	function (value, _p2) {
		var _p3 = _p2;
		return {ctor: '_Tuple2', _0: value * _p3._0, _1: value * _p3._1};
	});
var _user$project$Main$positions = function (face) {
	var _p4 = face;
	switch (_p4) {
		case 1:
			return {
				ctor: '::',
				_0: _user$project$Main$dieCM,
				_1: {ctor: '[]'}
			};
		case 2:
			return {
				ctor: '::',
				_0: _user$project$Main$dieTL,
				_1: {
					ctor: '::',
					_0: _user$project$Main$dieBR,
					_1: {ctor: '[]'}
				}
			};
		case 3:
		...
		case 4:
			return {
				...
				_1: {
					ctor: '::',
					_0: _user$project$Main$dieTR,
					_1: {
						ctor: '::',
						_0: _user$project$Main$dieBL,
						_1: {
							ctor: '::',
							_0: _user$project$Main$dieBR,
							_1: {ctor: '[]'}
		...
		case 6:
			return {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _user$project$Main$dieCL,
						_1: {
							ctor: '::',
							_0: _user$project$Main$dieCR,
							_1: {
								ctor: '::',
								_0: _user$project$Main$dieBL,
								_1: {
...
var _user$project$Main$rand = A2(
	_elm_lang$core$Random$generate,
...
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p5 = msg;
		if (_p5.ctor === 'Roll') {
			return {ctor: '_Tuple2', _0: model, _1: _user$project$Main$rand};
		} else {
			return {
				ctor: '_Tuple2',
				_0: A2(_user$project$Main$Model, _p5._0._0, _p5._0._1),
...
var _user$project$Main$results = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$class('results'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
				...
				{ctor: '[]'},
				{
					...
					_0: _elm_lang$html$Html$text(
						A2(
							...
							'Total: ',
							_user$project$Main$total(model))),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$class('table'),
					_1: {ctor: '[]'}
				},
				{ctor: '[]'}),
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Main$results(model),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$div,
								{
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$class('dice'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
